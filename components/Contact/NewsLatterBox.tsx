...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 rounded-sm bg-white p-4 sm:p-6 lg:p-4 xl:p-6"
      data-wow-delay=".2s"
    >
      ...
      <div className="mb-4">
        <div className="relative w-full overflow-hidden rounded-sm">
          <iframe
            title="SAYVAI SOFTWARE Location"
            src="https://www.google.com/maps?q=SAYVAI%20SOFTWARE&ll=11.0291559,77.0274262&z=17&output=embed"
